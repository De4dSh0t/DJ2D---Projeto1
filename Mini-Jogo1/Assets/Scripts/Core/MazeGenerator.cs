...
namespace Core
{
    public class MazeGenerator : MonoBehaviour
    {
        ...
        private readonly List<Vector2Int> visitedCellsPosition = new List<Vector2Int>();
        private readonly Stack<Vector2Int> positionStack = new Stack<Vector2Int>();
        private readonly List<Vector2Int[]> stackList = new List<Vector2Int[]>();
